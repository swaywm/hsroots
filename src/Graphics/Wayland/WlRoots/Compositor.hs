...
foreign import ccall "wlr_compositor_create" c_compositor_create :: Ptr DisplayServer -> Ptr Backend -> IO (Ptr WlrCompositor)

compositorCreate :: DisplayServer -> Ptr Backend -> IO (Ptr WlrCompositor)
