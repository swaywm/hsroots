...
foreign import ccall unsafe "wlr_backend_is_libinput" c_is_libinput :: Ptr Backend -> IO Bool

backendIsLibinput :: Ptr Backend -> IO Bool
backendIsLibinput = c_is_libinput

foreign import ccall unsafe "wlr_input_device_is_libinput" c_input_is_libinput :: Ptr InputDevice -> IO Bool

inputDeviceIsLibinput :: Ptr InputDevice -> IO Bool
inputDeviceIsLibinput = c_input_is_libinput
